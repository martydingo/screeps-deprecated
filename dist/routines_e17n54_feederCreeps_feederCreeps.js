...
var routines_e17n54_feederCreeps_feederCreep = {
    run: function () {
        const room = 'E17N54'
        const energySource = config_e17n54_sources.srcTwo
    ...
    creepWatch: function (spawn, feederCreeps, feederCreep) {
        if (feederCreeps.length < config_e17n54_respawn.maxActive.feederCreep) {
...
module.exports = routines_e17n54_feederCreeps_feederCreep
