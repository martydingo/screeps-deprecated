class classes_creeps_snipeCreep {
    constructor(snipePos, roomName, partsArray){
        ...
        this.partsArray = partsArray || [TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,MOVE,MOVE,MOVE,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK]
    ...
    rangedAttack(creep){
        ...
        if(this.badGuys.length > 0){
            ...
            creep.moveTo(Game.flags['snipeFlag0001'],{visualizePathStyle: {stroke: '#ffaa00'}})
        }
    }
        ...
        if(this.healerCreeps.length > 0){
           if(creep.pos.inRangeTo(this.healerCreeps[0],1)){
                if(creep.pos.roomName != this.roomName){
                    creep.moveTo(new RoomPosition(25,25,this.roomName),{visualizePathStyle: {stroke: '#ffaa00'}})
                } else {
               ...
               if(creep.pos.roomName == this.roomName){
                   if(this.healerCreeps[0].pos.roomName != this.roomName){
                       creep.moveTo(new RoomPosition(47, 35, this.roomName),{visualizePathStyle: {stroke: '#ffaa00'}})
                   }
               }
            }
        }
