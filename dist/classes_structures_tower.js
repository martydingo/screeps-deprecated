class classes_structures_tower {
    ...
    healTarget(target) {
        ...
        this.result = this.tower.heal(target)
        return this.result
    }
    attackTarget(target) {
        this.tower = this.tower
        this.result = this.tower.attack(target)
        return this.result
    }
    repairTarget(target) {
        this.result = this.tower.repair(target)
        return this.result
    }
    run() {
        this.injuredCreeps = this.tower.room.find(FIND_MY_CREEPS, {
