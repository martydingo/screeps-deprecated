...
var routines_e17n55_sourceCreeps_srcOne = {
    ...
    run: function () {
        ...
        sourceCreep = new classes_creeps_sourceCreep(null,energySource,room,[WORK,WORK,MOVE,CARRY])
    ...
    creepWatch: function (spawn, sourceCreeps,sourceCreep) {
        if (sourceCreeps.length < config_e17n55_respawn.maxActive.sourceCreep.srcOne) {
