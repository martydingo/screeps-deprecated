...
var routines_e16n53_keaniumCreeps_keaniumCreep = {
    run: function () {
        const room = 'E16N53'
        const spawn = Game.spawns['E17N53SPA1']
        const keanium = '5bbcb36440062e4259e94365'
        const keaniumStore = '6071a510015f30575a4c36c5'
        const holdingPos = new RoomPosition(46, 17, 'E16N53')

        var keaniumCreeps = _.filter(
            Game.creeps,
            (creep) => creep.memory.creepClass == 'keaniumCreep' && creep.memory.creepRoom == 'E16N53'
        )
    ...
    creepWatch: function (spawn, keaniumCreeps, keaniumCreep) {
        if (keaniumCreeps.length < config_e16n53_respawn.maxActive.keaniumCreep) {
...
module.exports = routines_e16n53_keaniumCreeps_keaniumCreep
