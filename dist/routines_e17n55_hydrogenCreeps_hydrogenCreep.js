...
var routines_e17n55_hydrogenCreeps_hydrogenCreep = {
    run: function () {
        ...
        const hydrogen = '5bbcb36440062e4259e94363'
        const hydrogenStore = '6068f22ec5078bd54b49e57c'
        const holdingPos = new RoomPosition(46, 17, 'E17N55')

        var hydrogenCreeps = _.filter(
            Game.creeps,
            (creep) => creep.memory.creepClass == 'hydrogenCreep' && creep.memory.creepRoom == 'E17N55'
        )
