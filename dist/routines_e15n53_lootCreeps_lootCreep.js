...
var routines_e15n53_lootCreeps_lootCreep = {
    run: function () {
        const room = 'E15N53'
    ...
    creepWatch: function (spawn, lootCreeps, lootCreep) {
        if (lootCreeps.length < config_e15n53_respawn.maxActive.lootCreep) {
...
module.exports = routines_e15n53_lootCreeps_lootCreep
