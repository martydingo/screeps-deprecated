...
var routines_e16n53_sourceCreeps_srcOne = {
    run: function () {
        const room = 'E16N53'
    ...
    creepWatch: function (spawn, sourceCreeps, sourceCreep) {
        if (sourceCreeps.length < config_e16n53_respawn.maxActive.sourceCreep.srcOne) {
...
module.exports = routines_e16n53_sourceCreeps_srcOne
