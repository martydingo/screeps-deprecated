...
class classes_creeps_mistCreep {
    ...
    unloadMist(creep){
        if(this.storage == null){
            ...
            this.extensions = creep.pos.findClosestByPath(FIND_STRUCTURES, {
                filter:  object => object.structureType == STRUCTURE_EXTENSION && object.store.getFreeCapacity(RESOURCE_MIST) > 0
            })
            this.towers = creep.pos.findClosestByPath(FIND_STRUCTURES, {
                filter:  object => object.structureType == STRUCTURE_TOWER && object.store.getFreeCapacity(RESOURCE_MIST) > 0
            })
        ...
        if(this.unloadDest.hits < this.unloadDest.hitsMax){
            ...
            if(this.result == ERR_NOT_IN_RANGE) {
                if(this.creep.pos.roomName == 'E19N50'){
    ...
    run(creep){
        if(creep.store.getFreeCapacity(RESOURCE_MIST) < 200){
