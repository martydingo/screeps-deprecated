...
config_e16n53_sources = require('config_e16n53_sources')
...
var routines_e16n53_feederCreeps_feederCreep = {
    run: function () {
        ...
        const energySource = config_e16n53_sources.srcTwo
        ...
        var feederCreep = new classes_creeps_feederCreep(origin,energySource,roomController,room,[MOVE,CARRY,MOVE,CARRY,MOVE,CARRY]);
    ...
    creepWatch: function (spawn, feederCreeps, feederCreep) {
        if (feederCreeps.length < config_e16n53_respawn.maxActive.feederCreep) {
