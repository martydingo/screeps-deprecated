...
var routines_e15n53_upgradeCreeps_srcOne = {
    run: function () {
        ...
        var upgradeCreep = new classes_creeps_upgradeCreep(storage,energySource,roomController,room,upgradeFromPOS,'60802877f9b1d6c57c1f2736',[WORK,WORK,MOVE,CARRY,WORK,MOVE,MOVE,MOVE,CARRY,CARRY,MOVE,MOVE]);
