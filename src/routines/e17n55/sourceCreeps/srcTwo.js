...
var routines_e17n55_sourceCreeps_srcTwo = {
    run: function () {
        ...
        var sourceCreep = new classes_creeps_sourceCreep('60871e0f59886d6f70b5d713',energySource,room,[WORK,WORK,WORK,WORK,WORK,WORK,MOVE,CARRY]);
        )
    ...
    creepWatch: function (spawn, sourceCreeps, sourceCreep) {
        if (
            sourceCreeps.length <
            config_e17n55_respawn.maxActive.sourceCreep.srcTwo
        ) {
