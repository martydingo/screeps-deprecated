    ...
    room: {
        ...
        paintSpawnInfo: function () {
            for (spawnName in Game.spawns) {
                ...
                spawn.room.visual.text('E: ' + spawn.store[RESOURCE_ENERGY], spawn.pos.x, spawn.pos.y + 1.2, {
                    color: '#b58900',
                    font: 0.33,
                })
        ...
        paintRoomHUD: function () {
            for (spawnName in Game.spawns) {
                ...
                draw.text(
                    levelProgress + '/' + levelProgressCapacity,
                    drawPosX - 2 + levelProgressBarBGLength / 2,
                    drawPosY + 4.6,
                    {
                        color: '#ffffff',
                        font: 0.3,
