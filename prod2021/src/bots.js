...
const { hostiles, sources } = require('./vars')
        ...
        towerBot: {
            gatherSourceAndDeliverToTower: function (creep) {
                ...
                if (creep.store.getUsedCapacity() < 50) {
                    if (
                        creep.withdraw(
                            Game.getObjectById(configuration.bots.feederBots.E26N37.primarySpawn.source),
                            RESOURCE_ENERGY
                        ) == ERR_NOT_IN_RANGE
                    ) {
                    ...
                    tower.store.getCapacity(RESOURCE_ENERGY) - (creep.store.getCapacity(RESOURCE_ENERGY) + 10)
                ) {
            ...
            primarySpawn: {
                feedSpawnExtensions: function (creep) {
                    ...
                    if (creep.store[RESOURCE_ENERGY] < 50) {
                        ...
                        variables.spawns.E26N37.primarySpawn().energy <
                        variables.spawns.E26N37.primarySpawn().energyCapacity
                    ) {
                        if (
                            creep.transfer(variables.spawns.E26N37.primarySpawn(), RESOURCE_ENERGY) == ERR_NOT_IN_RANGE
                        ) {
                        ...
                        creep.transfer(variables.structures.extensions.E26N37.notFull()[0], RESOURCE_ENERGY) ==
                        ERR_NOT_IN_RANGE
                    ) {
            ...
            primarySpawn: {
                ...
                feedSpawnExtensions: function (creep) {
                    ...
                    if (creep.store[RESOURCE_ENERGY] < 50) {
                        if (
                            creep.withdraw(
                                Game.getObjectById(configuration.bots.feederBots.E27N38.primarySpawn.source),
                                RESOURCE_ENERGY
                            ) == ERR_NOT_IN_RANGE
                        ) {
                        ...
                        variables.spawns.E27N38.primarySpawn().energy <
                        variables.spawns.E27N38.primarySpawn().energyCapacity
                    ) {
                        if (
                            creep.transfer(variables.spawns.E27N38.primarySpawn(), RESOURCE_ENERGY) == ERR_NOT_IN_RANGE
                        ) {
                        ...
                        creep.transfer(variables.structures.extensions.E27N38.notFull()[0], RESOURCE_ENERGY) ==
                        ERR_NOT_IN_RANGE
                    ) {
                ...
                try {
                    ...
                    if (shouldGoUpgrade == false) {
                        if (variables.structures.storage.E26N37.primary()) {
                            if (
                                variables.structures.storage.E26N37.primary().store.getUsedCapacity([RESOURCE_ENERGY]) >
                                49
                            ) {
                    ...
                    try {
                        ...
                        if (shouldGoUpgrade == false) {
                            if (variables.structures.containers.E27N38.secondarySourceContainer()) {
                                if (
                                    variables.structures.storage.E27N38.secondarySourceContainer().store.getUsedCapacity(
                                        [RESOURCE_ENERGY]
                                    ) > 49
                                ) {
            ...
            run: function (creep) {
                ...
                if (!creep.memory.movedIntoSystem) {
                    ...
                    if (creep.memory.shouldBuild) {
                        ...
                        } else creep.moveTo(Game.flags['E25N37IdleArea'].pos)
                    } else {
                ...
                if (!creep.memory.movedIntoSystem) {
                    ...
                    if (creep.memory.shouldBuild) {
                        ...
                        if (targets.length) {
                            ...
                            this.repair(creep, targetsRepair[0])
                        } else creep.moveTo(Game.flags['E26N38IdleArea'].pos)
                    } else {
                        this.gatherSource(creep)
                    }
                }
                ...
                if (!creep.memory.movedIntoSystem) {
                    ...
                    if (creep.memory.shouldBuild) {
                        ...
                        if (targets.length) {
                            ...
                            this.repair(creep, targetsRepair[0])
                        } else creep.moveTo(Game.flags['E27N38IdleArea'].pos)
                    } else {
                        this.gatherSource(creep)
                    }
                }
    ...
    lootBot: {
        run: function (creep) {
            if (creep.store[RESOURCE_ENERGY] == 0) {
                ...
                (x = creep.transfer(variables.structures.storage.E26N37.primary(), RESOURCE_ENERGY) == ERR_NOT_IN_RANGE)
            ) {
                creep.moveTo(variables.structures.storage.E26N37.primary())
            } else if (
                creep.transfer(variables.structures.storage.E26N37.primary(), RESOURCE_GHODIUM_OXIDE) ==
                ERR_NOT_IN_RANGE
            ) {
                creep.moveTo(variables.structures.storage.E26N37.primary())
            } else {
